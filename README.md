#famous tests
> E.g. A simple test project with famous.

[![Build Status](https://travis-ci.org/bdero/famous-tests.svg?branch=master)](https://travis-ci.org/bdero/famous-tests) [![Dependency Status](https://david-dm.org/bdero/famous-tests.svg)](https://david-dm.org/bdero/famous-tests) [![devDependency Status](https://david-dm.org/bdero/famous-tests/dev-status.svg)](https://david-dm.org/bdero/famous-tests#info=devDependencies)
...
## Release History
 * 2015-04-13   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)
